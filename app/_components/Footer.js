                ...
                <div className={`mt-10 sm:mt-16 border-t pt-8 ${isDark ? 'border-white/10' : 'border-gray-100'}`}>
                    <div className="sm:flex sm:items-center sm:justify-between">
                        <ul className="flex flex-wrap gap-x-6 gap-y-2 text-xs font-semibold">
                            ...
                            <li>
                                <a href="#" className={`transition ${isDark ? 'text-white/40 hover:text-teal-400' : 'text-gray-400 hover:text-teal-600'}`}> Privacy Policy </a>
                            </li>
                            <li>
                                <a href="#" className={`transition ${isDark ? 'text-white/40 hover:text-teal-400' : 'text-gray-400 hover:text-teal-600'}`}> Cookie Settings </a>
                            </li>
                        </ul>
